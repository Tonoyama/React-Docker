      ...
      <React.Fragment>
        ...
        <AppBar position='static' aria-label="Global Navi">
          <Toolbar>
            ...
            <Typography className={classes.headerLogo} variant="subtitle1">Cloud React App</Typography>
            <Typography className={classes.headerTitleStyle} variant="subtitle1" >UIサンプル</Typography>
